          ...
          {teams.map((team) => (
            ...
            >
              ...
              <div className="z-10 flex flex-col gap-4">
                ...
                <button className="mt-4 bg-green-500 hover:bg-green-600 text-black font-semibold py-2 px-4 rounded-lg shadow-lg transition-transform transform hover:scale-105 w-full">

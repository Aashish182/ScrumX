...
const SideBar = () => {
  ...
  const userRole = user?.role || "developer"; // 👈 role check
  ...
  return (
    <aside
      className={`fixed top-0 left-0 h-screen bg-[#1E1E1E] text-white flex flex-col justify-between px-3 py-6 shadow-lg z-50
        ${isOpen ? "w-64" : "w-20"} `}
    >
